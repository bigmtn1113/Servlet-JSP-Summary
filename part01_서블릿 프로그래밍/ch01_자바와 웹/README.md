...
### 1.1.2. Java ME
모바일 장치나 내장형 장치(휴대전화, 셋톱 박스, PDA)와 같은 `소형 장치`에서 실행되는 자바 애플리케이션을 기원하기 위해 경량화된 기술들을 지원하는 플랫폼이다.
...
- 정적인 웹 문서: 요청 시마다 항상 같은 내용을 클라이언트로 전달한다. ex) HTML, GIF, JPG, PDF, PPT 등  
